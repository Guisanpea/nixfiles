...
(setq catppuccin-flavor 'latte) ;; or 'latte, 'macchiato, or 'moca
...
(use-package ultra-scroll
  :init
  ;; Recommended settings from the package author.
  ;; `scroll-conservatively` is important for avoiding jumpy behavior.
